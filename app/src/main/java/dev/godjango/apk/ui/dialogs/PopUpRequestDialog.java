...
public class PopUpRequestDialog extends DialogFragment {
    private Dialog firstDialog;
    private Bundle cardData;
    private double pay;

    public static PopUpRequestDialog newInstance(String name, String lastName, String email, String countryNumber, String phoneNumberText, String country, double pay, double total_to_pay) {
        PopUpRequestDialog fragment = new PopUpRequestDialog();
    ...
    public void onStart() {
        ...
        if (getArguments() != null) {
            ...
            pay = getArguments().getDouble("pay");
            if(pay != 0.0) {
