...
public class PopUpDeleteWorkDialog extends DialogFragment {
    private static final int DEFAULT_DIALOG_WIDTH_DP = 300;
    private int position;
    private OnDeleteWorkListener deleteWorkListener;

    public static PopUpDeleteWorkDialog newInstance(int position, OnDeleteWorkListener listener) {
        PopUpDeleteWorkDialog fragment = new PopUpDeleteWorkDialog();
