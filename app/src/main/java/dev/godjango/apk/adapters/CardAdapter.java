...
public class CardAdapter extends RecyclerView.Adapter<CardAdapter.CardViewHolder> {
    ...
    private final List<CardServicesData> services;
    private final List<CardServicesData> filteredServices;

    public interface OnItemClickListener {
        void onItemClick(CardServicesData cardServicesData);
    }

    public CardAdapter(List<CardServicesData> services, OnItemClickListener listener) {
    ...
    public void filterByCategory(String category) {
        ...
        if (category.equals("All")) {
            ...
            for (CardServicesData service : this.services) {
    ...
    public void updateList(List<CardServicesData> newServicesList) {
        this.filteredServices.clear();
    ...
    public void onBindViewHolder(CardViewHolder holder, int position) {
        CardServicesData service = this.filteredServices.get(position);
