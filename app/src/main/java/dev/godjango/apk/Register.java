...
public class Register extends BottomSheetDialogFragment {
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        password_visible.setOnClickListener(view2 -> Register.onViewCreated(PasswordVisibility, password_visible, password_edit_text));
        button_accept_request.setOnClickListener(Register.this::AcceptRequest);
    }
